          ...
          {!estimateResult && currentStep > 0 && (
            ...
            >
              <button
                ...
                className="inline-flex items-center px-6 py-3 bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
          ...
          <AnimatePresence mode="wait">
            {!estimateResult ? (
              ...
              >
                ...
                {/* 現在の選択内容表示 */}
                {Object.entries(estimateData).some(([key, value]) => value && key !== questions[currentStep].id) && (
                  <motion.div
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="mt-8 p-6 bg-zinc-700/50 rounded-xl border border-zinc-600"
                  >
                    <h3 className="text-lg font-bold text-amber-400 mb-4">現在の選択内容</h3>
